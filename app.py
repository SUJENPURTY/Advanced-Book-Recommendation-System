...
from Advanced_Books_recomender.pipeline.training_pipeline import TrainingPipeline
...
if __name__ == "__main__":
    ...
    book_names = pickle.load(open('artifacts/serialized_objects/book_names.pkl', 'rb'))
